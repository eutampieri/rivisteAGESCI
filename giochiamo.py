...
for datiAnno in loads(requests.post("https://www.agesci.it/?wpfilebase_ajax=1", {"root":"wpfb-cat-119", "private":"0","sort[file]":"file_post_id","sort[cat]":'', "wpfb_action":"tree", "type":"browser", "base":"0"}, verify=False, headers={"User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:58.0) Gecko/20100101 Firefox/58.0"}).text):
